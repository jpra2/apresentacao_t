...
\begin{tikzpicture}[node distance=2cm]
  ...
  \node (proc1) [process, below of=proc0] {Calcular a velocidade e o número de mols de explicitamente};
  \node (proc2) [process, below of=proc1, yshift=-0.4cm] {Teste de estabilidade, cálculo do flash e das propriedades};
